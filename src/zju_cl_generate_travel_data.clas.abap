CLASS zju_cl_generate_travel_data DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zju_cl_generate_travel_data IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.
    DATA itab TYPE TABLE OF zju_travel_000.
...
*   delete existing entries in the database table
    DELETE FROM zju_travel_000.

*   insert the new table entries
    INSERT zju_travel_000 FROM TABLE @itab.
